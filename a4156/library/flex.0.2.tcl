package provide flex 0.2 ;# 2008-01-18

set commandes {
AB ACH AV AZ
BC BGI BGV BSI BSM BSSI BSSV BST BSV BSVM
CA *CAL? CL CLOSE *CLS CM CMD? CMM CN
DI DO DV DZ
END ERR? ESC *ESE *ESE? *ESR?
FL FMT
GOC
*IDN? IN
LGI LGV LOP? *LRN? LSI LSSI LSSV LST? LSTM LSV LSVM
MCC MI MM MP MSC MT MV
NUB?
*OPC *OPC? OPEN *OPT? OS
PA PI POR PRN PT PV PWI PWV
QSL QSM QSR QST QSV QSZ QSZ?
RBC RCV RD? RI RMD? *RST RU RV RZ
SCR SDSK SIT SLI SOC SPG SPL SPP SPR *SRE *SRE?
SRP SSP ST *STB? STC STG STI STM STP STT STV :SYST:ERR?
TDI TDV TI TI? TM TSC TSQ? TSR *TST? TTI TTI? TTV TTV? TV TV? UNT?
US US42
VM VMD
*WAI WI WM WNU? WR WS WSI WSV WT WV
XE
}
