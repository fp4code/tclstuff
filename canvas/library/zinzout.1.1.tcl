package provide fidev_zinzout 1.1
...
proc ::fidev::zinzout::updateOrCreate {win args} {
    ...
    if {[winfo exists $c]} {
       ...
       # la dénomination des events est étrange
        ...
        bind $c <ButtonPress-2> {::fidev::zinzout::b2Press %W %x %y}
        bind $c <ButtonPress-3> {::fidev::zinzout::b3Press %W %x %y}
...
proc ::fidev::zinzout::zout {c oper x y} {
    upvar #0 ::fidev::zinzout::[winfo parent $c] G
...
proc ::fidev::zinzout::b1Press {c x y} {
    ...
    switch $G(button1) {
        ...
        pan " ::fidev::zinzout::zout $c zoom $x $y"
    }
}

proc ::fidev::zinzout::b2Press {c x y} {
    upvar #0 ::fidev::zinzout::[winfo parent $c] G
    switch $G(button1) {
        pan " ::fidev::zinzout::zout $c pan $x $y"
    }
}

proc ::fidev::zinzout::b3Press {c x y} {
    upvar #0 ::fidev::zinzout::[winfo parent $c] G
    switch $G(button1) {
        pan " ::fidev::zinzout::zout $c unzoom $x $y"
    }
}
