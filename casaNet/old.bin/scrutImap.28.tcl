...
##
## scrutImap.1.0.tcl 22 mars 2003 (FP)
## scrutImap.28.tcl lecture de mail/maison-lpn au lieu de INBOX
## Erreurs autorisées, msecPartiDuLabo supprimé
## RECENT supprimé
##

puts stderr "Variante=./scrutImap.28.tcl >| ~/Z/s.log 2>&1"
...
proc selectImap {} {
    ...
    itagIncr
    putsImap "$STATUS(message) SELECT mail/maison-lpn"
...
proc searchImap {} {
    global STATUS IMAPSOCK
    itagIncr
    putsImap "$STATUS(message) SEARCH UNSEEN SUBJECT maison-lpn"
