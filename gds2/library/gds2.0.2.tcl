...
proc gds2::scan5 {s} {
    ...
    for {set i 0} {$i < $len} {incr i 8} {
        ...
        if {[lindex $m 0] == 0} {
	    puts stderr "denormalised 8-byte real"
...
proc gds2::formatSREF {} {
    global TYPEVAL
    return [gds2::formatRecord $TYPEVAL(SREF) {}]
}

proc gds2::formatAREF {} {
    global TYPEVAL
    return [gds2::formatRecord $TYPEVAL(AREF) {}]
}
...
proc gds2::formatCOLROW {colrow} {
    global TYPEVAL
    return [gds2::formatRecord $TYPEVAL(COLROW) $colrow]
}
...
proc gds2::formatSNAME {sname} {
    global TYPEVAL
    return [gds2::formatRecord $TYPEVAL(SNAME) $sname]
}
...
proc gds2::formatSref {sref} {
    ...
    append gds2 [gds2::formatSNAME $sname]
    if {$strans != {}} {
        append gds2 [gds2::formatSTRANS $strans]
    }
    append gds2 [gds2::formatXY $xy]
    foreach property $properties {
        append gds2 [gds2::formatProperty $property]
...
proc gds2::formatAref {aref} {
    ...
    append gds2 [gds2::formatCOLROW $colrow]
    append gds2 [gds2::formatXY $xy]
    foreach property $properties {
        append gds2 [gds2::formatProperty $property]
    }
