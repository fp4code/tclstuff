set HELP(gpib.tcl) {
    ...
    2005-11-23 (FP) possibilité de contrôler le delai entre scrutation du SRQ, tentative ajout eos
...
set ::GPIBBoard::SRQ_period 20

proc ::GPIBBoard::scruteSRQ_periodic {board} {
    ::GPIBBoard::scruteSRQ $board
    after $::GPIBBoard::SRQ_period ::GPIBBoard::scruteSRQ_periodic $board
}

proc ::GPIBBoard::iniSRQ {board} {
    ::GPIBBoard::scruteSRQ_periodic $board
}
...
proc GPIB::newGPIB {classe nom board addr} {
	...
	} elseif {$Arr(classe) == "2400"} {
	    package require 2400
	    set prefix ::2400::
	    set firstarg "2400Name"
