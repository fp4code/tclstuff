...
set rien {
    ...
    if {![info exists ASDEXDATA]} {
        set ASDEXDATA(rootData) /bob/asdex/data
    ...
    GPIB::newGPIB 2000 k2000   $GPIB_board 11
    GPIB::newGPIB egg7260 egg  $GPIB_board 12
    GPIB::newGPIB 2361 synchro $GPIB_board 15
    GPIB::newGPIB smu  smu1    $GPIB_board 16
    GPIB::newGPIB smu  smu2    $GPIB_board 17
    GPIB::newGPIB smu  smu3    $GPIB_board 18
    GPIB::newGPIB smu  smu_1A  $GPIB_board 23
