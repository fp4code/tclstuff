    ...
    $B.echantillon_mparams configure -command {
            ...
            if {![file exists $f]} {
                set of [tk_getOpenFile \
                    ...
                    -initialdir $fidev_tclDir/masque/modeles \
...
#########
    ...
    grid configure $B.frame#1 -in $root    -row 0 -column 0 
        ...
        grid configure $B.pos.tc550  $B.pos.calcule $B.pos.print  -sticky news
        grid configure $B.pos.mm4005 $B.pos.lico      -           -sticky news
