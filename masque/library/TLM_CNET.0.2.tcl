# 2014-05-21 (FP) added getWidth, changed 20 -> 020, etc.
package provide TLM_CNET  0.2
...
namespace eval TLM_CNET {
    ...
    set xyDispo(tlmA020)  { 170     0}
    set xyDispo(tlmB020)  { 170  -220}
    set xyDispo(tlmA040)  { 240     0}
    set xyDispo(tlmB040)  { 240  -220}
    set xyDispo(tlmA060)  { 330     0}
    set xyDispo(tlmB060)  { 330  -220}
...
proc ::TLM_CNET::splitGeomTlm {symdes} {
    if {![regexp {^[0-9][0-9][A-Z](tlm[AB])([0-9]+)$} $symdes tout couche distance]} {
