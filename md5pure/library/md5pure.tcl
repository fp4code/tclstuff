...
# Version 1.1.0
#
# MD5 is defined by RFC 1321, "The MD5 Message-Digest Algorithm"
#
# Most of the comments below come right out of the RFC; That's why
# they have such peculiar numbers.  In addition, I have retained
# original syntax, bugs in documentation (yes, really), etc. from
# the RFC.  All remaining bugs are mine.
#
