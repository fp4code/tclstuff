package provide mes_bipolaire 1.7
...
proc mes::controlLimit {&loglo thingName unit symDes thingPerUnitOfSurface} {
    ...
    if {[info exists loglo($thingName,$family)]} {
        ...
        puts -nonewline stderr "******* no loglo($thingName,$family), $thingName from surface"
    }
    puts stderr " -> $thing"
}
...
proc ::mes::bipolaire::diodeBx_InvFR {EouC args} {
    ...
    mes::controlLimit gloglo IbInvMax A $symDes [readUnit $gloglo(J${eouc}InvMax) A*um-2]
...
proc ::mes::bipolaire::IcVceFR {IbFractionDeIceMax betaMax args} {
    ...
    mes::controlLimit gloglo pmax W $symDes [readUnit $gloglo(PMax) W*um-2]
