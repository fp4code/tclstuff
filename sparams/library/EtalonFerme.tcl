...
set CALCUL sparams::EtalonFerme

set fichier /home/asdex/A/data/G000106/G000106.0/hyper/60A5x17/0mA0V.spt
...
proc sparams::EtalonFerme {&s &PMOD omega} {
    upvar ${&s} s
    upvar ${&PMOD} PMOD
    global 2M_PI
...
set lg [list]
foreach p {nL Zrel Rskin Rp Cp cc_ext ce_ext} {
