# 2006-03-21 (FP) ajout de ESCAPED et changement de -nogood en -trie $char

package provide superWidgetsListbox 1.3
...
proc widgets::listbox3_key {w char commande} {
    ...
    if {$ESCAPED} {
	if {$char == "\r" || $char == "\033"} {
	    error "Il faut presser une lettre après la touche Esc"
	} else {
	    eval $commande -trie $char $SELECTED($w)
