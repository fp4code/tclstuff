...
proc getByTelnet {} {
    ...
    expect {
        -re {(|$%) } {
            exp_send "stty raw; echo BEGIN.BEGIN.BEGIN; md5sum /etc/mail/aliases; md5sum /etc/passwd; cat /etc/mail/aliases; echo NEXT.NEXT.NEXT; cat /etc/passwd; echo END.END.END\r"
        }
        timeout {
