...
button .b -text commande -command {
    ...
    foreach c {10 20} {
        ...
        foreach pas {150 200} {
            ...
            tpg::Struct::new raccord${c}_1_$pas
            raccordAcces $c $pas $x2
            ...
            tpg::Struct::new raccord${c}_2_$pas
            ...
            tpg::Struct::new raccord${c}_3_$pas
            raccordAcces $c $pas $xm
            ...
            tpg::Struct::new raccord${c}_n_$pas
            raccordAcces $c $pas $xm
            ...
            tpg::Struct::new raccord${c}_i_$pas
            raccordAcces $c $pas $xm
    ...
    foreach c {10 20} {
        foreach pas {150 200} {
            foreach type {1 2 3 n i} {
                inJeolChip 100000 300000 300000 -150000 150000 rotation90 [string toupper centre${c}m${type}p$pas] centre${c}_${type}_$pas
            }
        }
    }
...
#steph402a.ltl    
    ...
    set PN(1) CENTRE10M1P150
    set PN(2) CENTRE10M2P150
    set PN(3) CENTRE10M3P150
    set PN(4) CENTRE10MNP150
    set PN(5) CENTRE10MIP150
    set PN(6) CENTRE20M1P150
    set PN(7) CENTRE20M2P150
    set PN(8) CENTRE20M3P150
    set PN(9) CENTRE20MNP150
    set PN(10) CENTRE20MIP150
    set PN(11) CENTRE10M1P200
    set PN(12) CENTRE10M2P200
    set PN(13) CENTRE10M3P200
    set PN(14) CENTRE10MNP200
    set PN(15) CENTRE10MIP200
    set PN(16) CENTRE20M1P200
    set PN(17) CENTRE20M2P200
    set PN(18) CENTRE20M3P200
    set PN(19) CENTRE20MNP200
    set PN(20) CENTRE20MIP200
    set PN(21) CROIX80
    ...
    for {set li 1} {$li <= 14} {incr li} {
        place CENTRE10M1P150 300000 300000 $li 1
        place CENTRE10M2P150 300000 300000 $li 2
        place CENTRE10M3P150 300000 300000 $li 3
        place CENTRE10MNP150 300000 300000 $li 4
        place CENTRE10MIP150 300000 300000 $li 5
        place CENTRE20M1P150 300000 300000 $li 6
        place CENTRE20M2P150 300000 300000 $li 7
        place CENTRE20M3P150 300000 300000 $li 8
        place CENTRE20MNP150 300000 300000 $li 9
        ...
        place CENTRE10M1P200 300000 300000 $li 1
        place CENTRE10M2P200 300000 300000 $li 2
        place CENTRE10M3P200 300000 300000 $li 3
        place CENTRE10MNP200 300000 300000 $li 4
        place CENTRE10MIP200 300000 300000 $li 5
        place CENTRE20M1P200 300000 300000 $li 6
        place CENTRE20M2P200 300000 300000 $li 7
        place CENTRE20M3P200 300000 300000 $li 8
        place CENTRE20MNP200 300000 300000 $li 9
...
###############################
    ...
    place raccord10_1_150 300000 300000 1 1
    place raccord10_2_150 300000 300000 2 1
    place raccord10_3_150 300000 300000 3 1
    place raccord10_n_150 300000 300000 4 1
    place raccord10_i_150 300000 300000 5 1
    place raccord20_1_150 300000 300000 6 1
    place raccord20_2_150 300000 300000 7 1
    place raccord20_3_150 300000 300000 8 1
    place raccord20_n_150 300000 300000 9 1
    place raccord20_i_150 300000 300000 10 1

    tpg::sref viseur [expr {$OFFX - 150000}] [expr {$OFFY - 25000000 + 150000}]

    place raccord10_1_200 300000 300000 1 2
    place raccord10_2_200 300000 300000 2 2
    place raccord10_3_200 300000 300000 3 2
    place raccord10_n_200 300000 300000 4 2
    place raccord10_i_200 300000 300000 5 2
    place raccord20_1_200 300000 300000 6 2
    place raccord20_2_200 300000 300000 7 2
    place raccord20_3_200 300000 300000 8 2
    place raccord20_n_200 300000 300000 9 2
    ...
    tpg::outGds2 CONTACTS CONTACTS ~fab/W/Z/msm $time 1 1e-10
    tpg::outGds2 LB LB  ~fab/W/Z/msm $time 1 1e-10
    tpg::outGds2 LG LG ~fab/W/Z/msm $time 1 1e-10
