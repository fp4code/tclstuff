# RCS: @(#) $Id: eqvp.0.5.tcl,v 1.3 2002/06/25 08:43:10 fab Exp $

package provide eqvp 0.5

# 22 juin 2001 (FP) passage à supercomplex
# 23 juillet 2001 (FP) fidevObj
# 3 septembre 2001 (FP) extension aux guides simples
...
fidev_load ../src/libtclzeroscomplexes.0.5 zerosComplexes
...
proc ::zerosComplexes::beginOutside {alName polar eps1 eps2 d1N d2N kx0N XNm XNp YNmin YNmax divOfPeriod NDMAX DYMIN} {
    ...
    puts stderr "intervalles calculés"

    puts stderr "XNm: {xpmList ypmList xmmList ymmList} = [list $xpmList $ypmList $xmmList $ymmList]"
    puts stderr "XNp: {xppList yppList xmpList ympList} = [list $xppList $yppList $xmpList $ympList]"
