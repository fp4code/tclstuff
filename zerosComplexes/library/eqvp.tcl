...
load $fidev_libDir/libzeroscomplexes.so zerosComplexes
...
proc ::zerosComplexes::zeros {alName polar eps1 eps2 d1N d2N kx0N XNm XNp dl dtheta DZM1 DZM2 DZwarn} {
    upvar $alName al
	...
	lappend lm [::zerosComplexes::zeroOnCurve Im $polar $eps1 $eps2 $d1N $d2N $kx0N $Z 1 $dl $dtheta $DZM1 $DZM2]
    }
	...
	lappend lp [::zerosComplexes::zeroOnCurve Im $polar $eps1 $eps2 $d1N $d2N $kx0N $Z 1 $dl $dtheta $DZM1 $DZM2]
    }
